...
find static -name *.html -type f -exec sed -i -e 's#http://localhost:2368#https://dotnetdude.github.io#g' {} \;
...
find static -name *.html -type f -exec sed -i -e 's#open https://dotnetdude.github.io#open http://localhost:2368#g' {} \;
find static -name *.html -type f -exec sed -i -e 's#domain=https://dotnetdude.github.io#domain=http://localhost:2368#g' {} \;
find static -name *.html -type f -exec sed -i -e 's#s\#https://dotnetdude.github.io#s\#http://localhost:2368#g' {} \;
